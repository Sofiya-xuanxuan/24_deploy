  ...
  function (_Component) {
    ...
    _createClass(ObserverComponent, [{
      ...
      value: function componentWillMount() {
        ...
        this._reaction = new Reaction("".concat(initialName, "_").concat(Date.now()), function () {
  ...
  target._createData = function () {
    ...
    if (this._reaction && this._reaction instanceof Reaction) {
      this._reaction.track(function () {
        try {
          result = _allowStateChanges(false, originCreateData.bind(_this2));
        } catch (e) {
          exception = e;
        }
      });
...
function createStoreInjector(grabStoresFn, injectNames, Component) {
  ...
  function (_Component) {
    ...
    function Injector(props, isPage) {
      ...
      return _possibleConstructorReturn(this, _getPrototypeOf(Injector).call(this, Object.assign.apply(Object, Array.prototype.slice.call(arguments).concat([mapStoreToProps(grabStoresFn, props)])), isPage));
    }
...
export { getStore, setStore, observer, inject, Provider };
